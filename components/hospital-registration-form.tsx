...
export function HospitalRegistrationForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("[Hospital Registration] Deriving encryption key...");
      ...
      console.log("[Hospital Registration] Encrypting profile...");
      ...
      if (!publicProfileResponse.ok) {
        console.warn("[Hospital Registration] Failed to save public profile, but private profile was saved");
        // Don't fail the whole registration if public profile fails
      }

      console.log("[Hospital Registration] Profile created successfully");
      onRegistrationComplete();
    } catch (err: any) {
  ...
  return (
    <Card className="max-w-2xl w-full glass-card py-8 px-8 space-y-6">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl font-bold text-gray-900">Complete Your Hospital Profile</h2>
        <p className="text-sm text-gray-600">
          Please provide your hospital information
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="St. Jude's Medical Center"
              className="w-full"
